          ...
          <span className="bg-white px-2 text-slate-600">Or continue with</span>
            ...
            <div className="flex flex-col items-center gap-4 mt-2 justify-center">
              <button
                ...
                className="mt-7 flex items-center gap-2 bg-white text-gray-800 rounded-lg text-xl shadow-md py-2 px-8"
              >
                <FcGoogle size={32} />
              ...
              <button
                ...
                className="my-3 flex items-center gap-2 bg-white text-gray-800 rounded-lg text-xl shadow-md py-2 px-8"
              >
                <FaGithub size={32} />
